...
type SelectProps = Omit<Props,"getOptionLabel"> & Partial<{
    className: string;
    ...
    (
        {
            ...
            isSearchable = false,
            isMulti = false,
            indicator, shape, variant = "outline", size= "xs", color="blue_gray_100",
            ...restProps
        }, ref
    ) => {
        ...
        return (
            <>
                ...
                className={`${className} flex ${shape } ${size } ${variant?.[color as keyof(typeof variants)]}`}
