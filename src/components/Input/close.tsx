...
const CloseSVG: React.FC<CloseSVGProps> = ({fillColor = "#000000", className="", ...props}) => {
    return (
        ...
        viewBox={`0 0 ${props?.width || 20} ${props?.height || 20}`}>
            <path d="M 4.7070312 3.2929688 L 3.2929688 4.7070312 L 10.585938 12 L 3.3939688 19.292969 L 4.7070312 20.707031 L 12 13.414062 L 19.292969 20.707031 L 20.707031"></path>
        </svg>
    )
};
